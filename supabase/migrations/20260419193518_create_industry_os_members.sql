...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'industry_os_members' AND policyname = 'Industry OS open select') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'industry_os_members' AND policyname = 'Industry OS open insert') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'industry_os_members' AND policyname = 'Industry OS open update') THEN
